...
// SOURCE: http://www.physics.emory.edu/astronomy/events/mars/calc.html
...
earthMarsLatency = function(unit) {
  var now = new Date();
  ...
  var latency = round_num(lt2*1440, 3);

  // Earth to mars latency in minutes
  return latency;
};
